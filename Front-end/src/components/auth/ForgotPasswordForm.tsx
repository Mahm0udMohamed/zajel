      ...
      >
        <div className="text-center mb-8">
          <motion.div
            ...
            animate={{ scale: 1 }}
            transition={{ delay: 0.2, type: "spring", stiffness: 200 }}
            className="w-16 h-16 bg-gradient-to-r from-warning-500 to-error-500 rounded-full flex items-center justify-center mx-auto mb-4"
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 rtl:pr-10 rtl:pl-4 pr-4 py-3 border border-border-primary rounded-xl focus:ring-2 focus:ring-warning-500 focus:border-transparent transition-all"
                placeholder={
          ...
          <motion.button
            type="submit"
            disabled={isLoading}
            className="w-full bg-gradient-to-r from-warning-500 to-error-500 text-white py-3 px-4 rounded-xl font-medium hover:from-warning-600 hover:to-error-600 transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
